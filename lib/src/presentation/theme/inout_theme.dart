...
final class InOutPalette extends ThemeExtension<InOutPalette> {
  ...
  static const light = InOutPalette(
    ...
    inPrimary: Color(0xFF1565C0),
    inContainer: Color(0xFFDCEBFF),
    inOnColor: Color(0xFFFFFFFF),
    outPrimary: Color(0xFFC62828),
    outContainer: Color(0xFFFFE1DF),
    outOnColor: Color(0xFFFFFFFF),
    focus: Color(0xFF6B4EFF),
    disabled: Color(0xFF9AA3B2),
    systemError: Color(0xFF8F1D18),
    systemWarning: Color(0xFF8A4B00),
  ...
  static const dark = InOutPalette(
    ...
    border: Color(0xFF39404D),
    inPrimary: Color(0xFF64A8FF),
    inContainer: Color(0xFF173A63),
    inOnColor: Color(0xFF07182C),
    outPrimary: Color(0xFFFF7770),
    outContainer: Color(0xFF5B2425),
    outOnColor: Color(0xFF310405),
    focus: Color(0xFFB7A8FF),
    disabled: Color(0xFF747C89),
    systemError: Color(0xFFFFB4AB),
    systemWarning: Color(0xFFFFB95C),
